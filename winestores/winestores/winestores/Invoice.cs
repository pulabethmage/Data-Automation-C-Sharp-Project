...
namespace winestores
{
    public partial class Invoice : Form
    {
        ...
        public Invoice(Form1 p1)
        {
            parent = p1;
            InitializeComponent();
        }
        public Invoice(Form1 p1,ToolStripMenuItem t1)
        {
            tool1 = t1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            da.InsertCommand = new SqlCommand("insert into invoice(manufact,invoceno,date,productname,qty,price,total)values (@manufact,@invoceno,@date,@productname,@qty,@price,@total)", connString);


            da.InsertCommand.Parameters.Add("@manufact", SqlDbType.VarChar).Value = comboBox1.SelectedItem.ToString();
            da.InsertCommand.Parameters.Add("@invoceno", SqlDbType.VarChar).Value = textBox2.Text;
            da.InsertCommand.Parameters.Add("@date", SqlDbType.VarChar).Value = dateTimePicker1.Value.ToShortDateString();
                string prona = comboBox2.SelectedItem.ToString();
            da.InsertCommand.Parameters.Add("@productname", SqlDbType.VarChar).Value = prona;

            int qtyIn = Int32.Parse(textBox4.Text);
            da.InsertCommand.Parameters.Add("@qty", SqlDbType.VarChar).Value = qtyIn;
           ...
           // textBox1.Clear();
            ...
            catch (NullReferenceException)
            {
                if (comboBox1.Text == "")
                {
                    MessageBox.Show("Please Choose a Manufacturer");
                }
        ...
        private void Invoice_Load(object sender, EventArgs e)
        {
            ...
            command1.CommandText = "SELECT manufact FROM product ";
            conn.Open();
            reader1 = command1.ExecuteReader();
           ...
           //// string manu = comboBox1.SelectedItem.ToString();
           // command2.CommandText = "SELECT productname FROM product where manufact = '" + productname12 + "';";
           // conn.Open();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //{
             connString.Open();
            da = new SqlDataAdapter("select manufact,invoceno,date,productname AS Product_Name,qty AS Quantity,price,total,invoauto from invoice where  invoceno = @invoceno ", connString);
            da.SelectCommand.Parameters.Add("@invoceno ", SqlDbType.VarChar).Value = textBox8.Text;
            sqlCommandBuilder = new SqlCommandBuilder(da);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string innNo = textBox7.Text;

            command3.CommandText = "DELETE from invoice where  invoceno =  '" + innNo + "';";
            conn.Open();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string manu = comboBox1.SelectedItem.ToString();
            command3.CommandText = "SELECT productname FROM product where manufact = '" + manu + "';";
            conn.Open();
            reader3 = command3.ExecuteReader();
            ...
            while (reader3.Read())
            {
                ...
                comboBox2.Items.Add(reader3.GetString(0));
        ...
        public void salinvoice(string proname, int quan)
        {
            ...
            command10.CommandText = "select initialstock,invoicestock,balancestock from stocktable where  productname  = '" + proname1 + "';";
            conn.Open();
            ...
            int inistock1234 = invoicestock12 + quan1;

            command11.CommandText = "UPDATE stocktable SET balancestock = " + balstock + " ,invoicestock = " + inistock1234 + "   WHERE productname = '" + proname1 + "'";
            conn.Open();
        ...
        public void updatestock(string proname, int quan)
        {
            ...
            int newinvoicestock1;
              int newinvoicestock2 = quan1 - invoicestock12;//100 - 120 = -20       //130 - 120 =   10      //50 - 120 = -70
              ...
              command11.CommandText = "UPDATE stocktable SET balancestock = " + newbalstock + " ,invoicestock = " + invoicestock123 + "   WHERE productname = '" + proname1 + "'";
              conn.Open();
              reader11 = command11.ExecuteReader();
              conn.Close();
